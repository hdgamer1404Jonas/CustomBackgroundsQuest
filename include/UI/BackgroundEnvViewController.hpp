...
DECLARE_CLASS_CODEGEN(CustomBackgrounds, BackgroundEnvViewController, HMUI::ViewController,
                      DECLARE_INSTANCE_FIELD(UnityEngine::UI::HorizontalLayoutGroup*, envcontainer);
